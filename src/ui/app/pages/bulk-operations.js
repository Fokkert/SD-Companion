(() => {
  ...
  A.pageBulkOperations = () => {
    ...
    return `<section class="page rules-page bulk-operations-page">` +
      ...
      `<div class="row-between"><div class="section-title">Detection method</div><div class="condition-match-toggle"><button type="button" class="${sourceMode === 'conditions' ? 'active' : ''}" data-action="rule-source-mode" data-value="conditions">Manual</button><button type="button" class="${sourceMode === 'jql' ? 'active' : ''}" data-action="rule-source-mode" data-value="jql">JQL</button></div></div>` +
